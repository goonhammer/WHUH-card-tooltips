...
Deckbox._ = {
    ...
    tooltip: function(which)  {
        ...
        //the below is the changed text
        if (which === 'cards') return this._cT = this._cT || new Deckbox.ui.Tooltip('deckbox_c_tooltip', 'cards');
    },
...
(function() {
    ...
    function onmousemove(event) {
        ...
        if (Deckbox._.needsTooltip(el)) {
            ...
            Deckbox._.tooltip('cards').move(posX, posY);
        }
    }
